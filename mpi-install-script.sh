...
mpi-run() {
  ...
  mpirun -n "${node_count}" --hostfile /proj/AdvOSUWMadison/ds/groups/group4/dm/tmp/hostfile /proj/AdvOSUWMadison/ds/groups/group4/dm/tmp/main
}
...
mpi-agg-benchmark() {
  ...
  cp /users/kkhare/git_proj/hostfile /proj/AdvOSUWMadison/ds/groups/group4/dm/tmp
  node_count=$(wc -l /users/kkhare/git_proj/hostfile | sed 's/[^0-9]*//g')
  mpirun -n "${node_count}" --hostfile /proj/AdvOSUWMadison/ds/groups/group4/dm/tmp/hostfile /proj/AdvOSUWMadison/ds/groups/group4/dm/tmp/benchmark_agg
}
...
mpi-intersect-benchmark() {
  ...
  cp /users/kkhare/git_proj/hostfile /proj/AdvOSUWMadison/ds/groups/group4/dm/tmp
  node_count=$(wc -l /users/kkhare/git_proj/hostfile | sed 's/[^0-9]*//g')
  mpirun -n "${node_count}" --hostfile /proj/AdvOSUWMadison/ds/groups/group4/dm/tmp/hostfile /proj/AdvOSUWMadison/ds/groups/group4/dm/tmp/benchmark_intersect
}
